...
evt.HouseDoor(3, 18)  -- "Buckskins and Bucklers"
evt.house[4] = 18  -- "Buckskins and Bucklers"
evt.HouseDoor(5, 32)  -- "Natural Magic"
evt.house[6] = 32  -- "Natural Magic"
evt.HouseDoor(7, 45)  -- "The Bubbling Cauldron"
evt.house[8] = 45  -- "The Bubbling Cauldron"
evt.HouseDoor(9, 56)  -- "Hu's Stallions"
evt.house[10] = 56  -- "Hu's Stallions"
evt.HouseDoor(11, 65)  -- "Sea Sprite"
evt.house[12] = 65  -- "Sea Sprite"
evt.HouseDoor(13, 77)  -- "Nature's Remedies"
evt.house[14] = 77  -- "Nature's Remedies"
evt.HouseDoor(15, 92)  -- "The Proving Grounds"
evt.house[16] = 92  -- "The Proving Grounds"
evt.HouseDoor(17, 104)  -- "Pierpont Townhall"
evt.house[18] = 104  -- "Pierpont Townhall"
evt.HouseDoor(19, 110)  -- "Emerald Inn"
evt.house[20] = 110  -- "Emerald Inn"
evt.HouseDoor(21, 130)  -- "Nature's Stockpile"
evt.house[22] = 130  -- "Nature's Stockpile"
evt.HouseDoor(23, 141)  -- "Master Guild of Fire"
evt.house[24] = 141  -- "Master Guild of Fire"
evt.HouseDoor(25, 145)  -- "Master Guild of Air"
evt.house[26] = 145  -- "Master Guild of Air"
evt.HouseDoor(27, 148)  -- "Adept Guild of Water"
evt.house[28] = 148  -- "Adept Guild of Water"
evt.HouseDoor(29, 152)  -- "Adept Guild of Earth"
evt.house[30] = 152  -- "Adept Guild of Earth"
evt.HouseDoor(32, 4)  -- "Hunter's Lodge"
evt.house[33] = 4  -- "Hunter's Lodge"
evt.hint[51] = evt.str[7]  -- "House"
evt.HouseDoor(52, 308)  -- "Bith Residence"
evt.HouseDoor(53, 309)  -- "Suretrail Home"
evt.HouseDoor(54, 310)  -- "Silverpoint Residence"
evt.HouseDoor(55, 311)  -- "Miyon's Home"
evt.HouseDoor(56, 312)  -- "Green House"
evt.HouseDoor(57, 313)  -- "Warlin Residence"
evt.HouseDoor(58, 314)  -- "Dotes Residence"
evt.HouseDoor(59, 315)  -- "Blueswan Home"
evt.HouseDoor(60, 316)  -- "Treasurestone Home"
evt.HouseDoor(61, 317)  -- "Windsong House"
evt.HouseDoor(62, 318)  -- "Whitecap Residence"
evt.HouseDoor(63, 319)  -- "Ottin House"
evt.HouseDoor(64, 320)  -- "Black House"
evt.HouseDoor(65, 321)  -- "Fiddlebone Residence"
evt.HouseDoor(66, 322)  -- "Kerrid Residence"
evt.HouseDoor(67, 323)  -- "Willowbark's Home"
evt.HouseDoor(68, 324)  -- "House 324"
evt.HouseDoor(69, 325)  -- "House 325"
evt.HouseDoor(70, 326)  -- "House 326"
evt.HouseDoor(71, 327)  -- "Benjamin's Home"
evt.HouseDoor(72, 328)  -- "Stonewright Residence"
evt.HouseDoor(73, 329)  -- "Weatherson's House"
evt.HouseDoor(74, 330)  -- "Sower Residence"
...
evt.map[204] = function()
	...
	if not evt.Cmp("AutonotesBits", 13) then         -- ""
		evt.Add("AutonotesBits", 13)         -- ""
	end
...
evt.map[503] = function()
	...
	evt.SetNPCTopic{NPC = 88, Index = 2, Event = 164}         -- "Archibald Ironfist" : "Clanker's Laboratory"
