...
evt.HouseDoor(3, 23)  -- "Avlee Outpost"
evt.house[4] = 23  -- "Avlee Outpost"
evt.HouseDoor(5, 60)  -- "Plush Coaches"
evt.house[6] = 60  -- "Plush Coaches"
evt.HouseDoor(7, 70)  -- "Wind Runner"
evt.house[8] = 70  -- "Wind Runner"
evt.HouseDoor(9, 84)  -- "Temple of Tranquility"
evt.house[10] = 84  -- "Temple of Tranquility"
evt.HouseDoor(11, 97)  -- "Avlee Gymnaisium"
evt.house[12] = 97  -- "Avlee Gymnaisium"
evt.HouseDoor(13, 119)  -- "The Potted Pixie"
evt.house[14] = 119  -- "The Potted Pixie"
evt.HouseDoor(15, 134)  -- "Halls of Gold"
evt.house[16] = 134  -- "Halls of Gold"
evt.HouseDoor(17, 162)  -- "Paramount Guild of Mind"
evt.house[18] = 162  -- "Paramount Guild of Mind"
evt.HouseDoor(19, 166)  -- "Paramount Guild of Body"
evt.house[20] = 166  -- "Paramount Guild of Body"
evt.HouseDoor(21, 9)  -- "The Knocked Bow"
evt.house[22] = 9  -- "The Knocked Bow"
evt.hint[51] = evt.str[7]  -- "House"
evt.HouseDoor(52, 376)  -- "Featherwind Residence"
evt.HouseDoor(53, 377)  -- "Ravenhair Residence"
evt.HouseDoor(54, 382)  -- "Snick House"
evt.HouseDoor(55, 383)  -- "Infernon's House"
evt.HouseDoor(56, 384)  -- "Deerhunter Residence"
evt.HouseDoor(57, 385)  -- "Swiftfoot's House"
evt.HouseDoor(58, 504)  -- "Tempus' House"
evt.HouseDoor(59, 505)  -- "Kaine's"
evt.HouseDoor(60, 506)  -- "Apple Residence"
evt.hint[61] = evt.str[9]  -- "Tent"
evt.HouseDoor(63, 378)  -- "Jillian's House"
evt.HouseDoor(64, 379)  -- "Greenstorm Residence"
evt.HouseDoor(67, 370)  -- "Brightspear Residence"
evt.HouseDoor(68, 371)  -- "Holden Residence"
...
evt.map[204] = function()
	...
	if not evt.Cmp("AutonotesBits", 31) then         -- ""
		evt.Add("AutonotesBits", 31)         -- ""
	end
...
evt.map[205] = function()
	...
	if not evt.Cmp("AutonotesBits", 30) then         -- ""
		evt.Add("AutonotesBits", 30)         -- ""
	end
