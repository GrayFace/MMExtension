...
evt.map[20] = function()  -- function events.LoadMap()
	evt.ForPlayer("All")
	if evt.Cmp("Inventory", 729) then         -- "Saints of Selinas Scroll 1"
		if evt.Cmp("Inventory", 730) then         -- "Saints of Selinas Scroll 2"
			if evt.Cmp("Inventory", 731) then         -- "Saints of Selinas Scroll 3"
				if evt.Cmp("Inventory", 732) then         -- "Saints of Selinas Scroll 4"
					if evt.Cmp("Inventory", 733) then         -- "Saints of Selinas Scroll 5"
						if evt.Cmp("Inventory", 735) then         -- "Saints of Selinas Scroll 6"
...
evt.house[63] = 342  -- "Avalanche's"
evt.map[63] = function()
	evt.EnterHouse(342)         -- "Avalanche's"
end
...
evt.house[66] = 345  -- "Empty House"
evt.map[66] = function()
	evt.EnterHouse(345)         -- "Empty House"
end

evt.house[67] = 346  -- "Duchess of Deja"
evt.map[67] = function()
	evt.EnterHouse(346)         -- "Duchess of Deja"
end

evt.house[68] = 347  -- "Kruella's Domain"
evt.map[68] = function()
	evt.EnterHouse(347)         -- "Kruella's Domain"
end
...
evt.house[71] = 499  -- "Wiseman Residence"
evt.map[71] = function()
	evt.EnterHouse(499)         -- "Wiseman Residence"
end
