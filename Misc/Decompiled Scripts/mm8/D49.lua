...
evt.HouseDoor(131, 484)  -- "Brimstone's Cave"
evt.hint[501] = evt.str[1]  -- "Leave Yaardrake's Cave"
evt.map[501] = function()
	evt.MoveToMap{X = 21749, Y = 21967, Z = 2144, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 3, Name = "Out06.odm"}
end
