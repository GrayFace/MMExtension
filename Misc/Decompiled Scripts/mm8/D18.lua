...
evt.map[11] = function()
	if not evt.Cmp("MapVar9", 1) then
		...
		evt.SummonMonsters{TypeIndexInMapStats = 1, Level = 3, Count = 1, X = 416, Y = 1296, Z = -128, NPCGroup = 1, unk = 0}         -- "Peasants on Main Island of Dagger Wound"
		evt.Set("MapVar9", 1)
	end
end
...
evt.map[13] = function()
	if not evt.Cmp("MapVar10", 1) then
		...
		evt.SummonMonsters{TypeIndexInMapStats = 1, Level = 3, Count = 1, X = 1744, Y = 368, Z = -128, NPCGroup = 1, unk = 0}         -- "Peasants on Main Island of Dagger Wound"
		evt.Set("MapVar10", 1)
	end
end
...
evt.map[14] = function()
	if not evt.Cmp("MapVar11", 1) then
		...
		evt.SummonMonsters{TypeIndexInMapStats = 1, Level = 3, Count = 1, X = 864, Y = -560, Z = -128, NPCGroup = 1, unk = 0}         -- "Peasants on Main Island of Dagger Wound"
		evt.Set("MapVar11", 1)
	end
end
...
evt.map[15] = function()
	if not evt.Cmp("MapVar12", 1) then
		...
		evt.SummonMonsters{TypeIndexInMapStats = 1, Level = 3, Count = 1, X = 416, Y = -576, Z = -128, NPCGroup = 1, unk = 0}         -- "Peasants on Main Island of Dagger Wound"
		evt.Set("MapVar12", 1)
	end
end
...
evt.map[76] = function()
	...
	evt.CastSpell{Spell = 6, Mastery = const.GM, Skill = 10, FromX = 1428, FromY = -1284, FromZ = 1208, ToX = 1428, ToY = -1284, ToZ = 760}         -- "Fireball"
	evt.CastSpell{Spell = 6, Mastery = const.GM, Skill = 10, FromX = 1632, FromY = -1284, FromZ = 1208, ToX = 1632, ToY = -1284, ToZ = 760}         -- "Fireball"
	evt.CastSpell{Spell = 6, Mastery = const.GM, Skill = 10, FromX = 1632, FromY = -1624, FromZ = 1208, ToX = 1632, ToY = -1624, ToZ = 760}         -- "Fireball"
	evt.CastSpell{Spell = 6, Mastery = const.GM, Skill = 10, FromX = 1428, FromY = -1624, FromZ = 1208, ToX = 1428, ToY = -1624, ToZ = 760}         -- "Fireball"
...
evt.hint[501] = evt.str[1]  -- "Leave the Naga Vault"
evt.map[501] = function()
	evt.MoveToMap{X = -14220, Y = 2552, Z = 290, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out05.odm"}
end
