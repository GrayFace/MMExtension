...
evt.map[1] = function()  -- function events.LoadMap()
	if not evt.Cmp("QBits", 223) then         -- Took Sub to Regna
		evt.Add("QBits", 223)         -- Took Sub to Regna
	end
end
...
evt.hint[501] = evt.str[1]  -- "Leave the Small Sub Pen"
evt.map[501] = function()
	evt.MoveToMap{X = 7425, Y = -2538, Z = 829, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out13.odm"}
end
