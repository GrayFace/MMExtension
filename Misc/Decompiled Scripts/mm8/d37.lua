local TXT = Localize{
	[0] = " ",
	[1] = "Leave the Prison of the Lord of Fire",
	[2] = "Door",
	[3] = "Chest",
	[4] = "Lever",
	[5] = "Button",
...
evt.HouseDoor(201, 442)  -- "Fire Lord's Cell"
evt.hint[501] = evt.str[1]  -- "Leave the Prison of the Lord of Fire"
evt.map[501] = function()
	evt.MoveToMap{X = -20044, Y = 20946, Z = 321, Direction = 0, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "pbp.odm"}
end
