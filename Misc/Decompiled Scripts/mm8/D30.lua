...
evt.map[451] = function()
	evt.MoveToMap{X = 0, Y = 640, Z = 679, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end

evt.hint[501] = evt.str[1]  -- "Leave the War Camp"
evt.map[501] = function()
	evt.MoveToMap{X = 9188, Y = -10940, Z = 3934, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "ElemF.odm"}
end
