...
evt.HouseDoor(131, 485)  -- "Duroth's Cave"
evt.hint[501] = evt.str[1]  -- "Leave Old Loeb's Cave"
evt.map[501] = function()
	evt.MoveToMap{X = 13168, Y = 14920, Z = 924, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 3, Name = "out13.odm"}
end
