...
evt.HouseDoor(131, 483)  -- "Flamdring's Cave"
evt.hint[501] = evt.str[1]  -- "Leave Ilsingore's Cave"
evt.map[501] = function()
	evt.MoveToMap{X = -17928, Y = 14096, Z = 2080, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 3, Name = "out04.odm"}
end
