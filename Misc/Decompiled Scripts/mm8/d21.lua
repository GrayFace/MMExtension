...
evt.hint[501] = evt.str[1]  -- "Leave the Vampire Crypt"
evt.map[501] = function()
	evt.MoveToMap{X = 11624, Y = 4562, Z = 1280, Direction = 1152, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "out06.odm"}
end
