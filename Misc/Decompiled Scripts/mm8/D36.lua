local TXT = Localize{
	[0] = " ",
	[1] = "Leave the Prison of the Lord of Air",
	[2] = "Door",
	[3] = "Chest",
	[4] = "Lever",
	[5] = "Button",
...
evt.HouseDoor(201, 439)  -- "Air Lord's Cell"
evt.hint[501] = evt.str[1]  -- "Leave the Prison of the Lord of Air"
evt.map[501] = function()
	evt.MoveToMap{X = 17459, Y = 18470, Z = 1024, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "pbp.odm"}
end
