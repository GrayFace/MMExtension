...
evt.hint[11] = evt.str[7]  -- "Lift"
evt.map[11] = function()
	evt.SetDoorState{Id = 71, State = 0}
end

evt.hint[12] = evt.str[7]  -- "Lift"
evt.map[12] = function()
	evt.SetDoorState{Id = 71, State = 1}
end

evt.hint[13] = evt.str[7]  -- "Lift"
evt.map[13] = function()
	evt.SetDoorState{Id = 72, State = 0}
end

evt.hint[14] = evt.str[7]  -- "Lift"
evt.map[14] = function()
...
evt.hint[501] = evt.str[1]  -- "Leave the Pirate Stronghold"
evt.map[501] = function()
	evt.MoveToMap{X = 8373, Y = -4645, Z = 1664, Direction = 0, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out13.odm"}
end

evt.hint[502] = evt.str[1]  -- "Leave the Pirate Stronghold"
evt.map[502] = function()
	evt.MoveToMap{X = 384, Y = -64, Z = 1, Direction = 948, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "D33.blv"}
end
