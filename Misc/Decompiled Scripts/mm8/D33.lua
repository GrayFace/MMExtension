local TXT = Localize{
	[0] = " ",
	[1] = "Leave the Passage Under Regna",
	[2] = "Door",
	[3] = "Chest",
	[4] = "Lever",
	[5] = "Button",
...
evt.hint[501] = evt.str[1]  -- "Leave the Passage Under Regna"
evt.map[501] = function()
	evt.MoveToMap{X = 160, Y = 3203, Z = -1342, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "D31.blv"}
end

evt.hint[502] = evt.str[1]  -- "Leave the Passage Under Regna"
evt.map[502] = function()
	evt.MoveToMap{X = 128, Y = -4352, Z = -160, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "D32.blv"}
end

evt.hint[503] = evt.str[1]  -- "Leave the Passage Under Regna"
evt.map[503] = function()
	if not evt.Cmp("QBits", 197) then         -- Door to the passage under regna from the northern watch tower is unlocked
		evt.Add("QBits", 197)         -- Door to the passage under regna from the northern watch tower is unlocked
	end
	evt.MoveToMap{X = 17730, Y = 2999, Z = 1617, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "out13.odm"}
end

evt.hint[504] = evt.str[1]  -- "Leave the Passage Under Regna"
evt.map[504] = function()
	if not evt.Cmp("QBits", 198) then         -- Door to the passage under regna from the southern watch tower is unlocked
		evt.Add("QBits", 198)         -- Door to the passage under regna from the southern watch tower is unlocked
	end
	evt.MoveToMap{X = 13470, Y = -15350, Z = 1617, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "out13.odm"}
end
