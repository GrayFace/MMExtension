...
evt.map[101] = function()
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 10, FromX = -5032, FromY = -4232, FromZ = 348, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 10, FromX = -4836, FromY = -4232, FromZ = 348, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 10, FromX = -4460, FromY = -4232, FromZ = 348, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 10, FromX = -4072, FromY = -4232, FromZ = 348, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 10, FromX = -3876, FromY = -4232, FromZ = 348, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 10, FromX = -5032, FromY = -4536, FromZ = 348, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 10, FromX = -4836, FromY = -4536, FromZ = 348, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 10, FromX = -4460, FromY = -4536, FromZ = 348, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 10, FromX = -4072, FromY = -4536, FromZ = 348, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 10, FromX = -3876, FromY = -4536, FromZ = 348, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
end
...
evt.map[131] = function()
	if not evt.Cmp("QBits", 81) then         -- Found the Sarcophagus of Korbu
		evt.SetFacetBit{Id = 10, Bit = const.FacetBits.Invisible, On = true}
		evt.SetFacetBit{Id = 10, Bit = const.FacetBits.Untouchable, On = true}
		evt.Add("Inventory", 612)         -- "Sarcophagus of Korbu"
		evt.Set("MapVar9", 1)
		evt.Add("QBits", 211)         -- Sarcophagus of Korbu - I lost it
	end
end

evt.hint[501] = evt.str[1]  -- "Leave the Crypt of Korbu"
evt.map[501] = function()
	evt.MoveToMap{X = 57, Y = 14827, Z = 1949, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "out08.odm"}
end
