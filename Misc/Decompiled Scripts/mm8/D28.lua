local TXT = Localize{
	[0] = " ",
	[1] = "Leave the Tomb of Lord Brinne",
	[2] = "Door",
	[3] = "Chest",
	[4] = "Lever",
	[5] = "Button",
	[6] = "Tomb of Lord Brinne",
	[7] = "",
	[8] = "",
	[9] = "Bookshelf",
	[10] = "",
...
evt.hint[451] = evt.str[6]  -- "Tomb of Lord Brinne"
evt.map[451] = function()
	if not evt.Cmp("QBits", 237) then         -- You got a flute
		evt.Add("Inventory", 634)         -- "Flute"
		evt.Add("QBits", 237)         -- You got a flute
	end
end

evt.hint[501] = evt.str[1]  -- "Leave the Tomb of Lord Brinne"
evt.map[501] = function()
	evt.MoveToMap{X = 18199, Y = 12520, Z = 1, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out02.odm"}
end
