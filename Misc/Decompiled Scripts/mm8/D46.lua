...
evt.map[451] = function()
	evt.MoveToMap{X = 1152, Y = -768, Z = -576, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end
...
evt.hint[501] = evt.str[1]  -- "Leave the Church of Eep"
evt.map[501] = function()
	evt.MoveToMap{X = -5012, Y = -470, Z = 1664, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "out08.odm"}
end
