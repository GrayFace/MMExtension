local TXT = Localize{
	[0] = " ",
	[1] = "Leave Prison of the Lord of Water",
	[2] = "Door",
	[3] = "Chest",
	[4] = "Lever",
	[5] = "Button",
...
evt.HouseDoor(201, 440)  -- "Water Lord's Cell"
evt.hint[501] = evt.str[1]  -- "Leave Prison of the Lord of Water"
evt.map[501] = function()
	evt.MoveToMap{X = -19900, Y = -19531, Z = 377, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "pbp.odm"}
end
