...
evt.hint[501] = evt.str[1]  -- "Leave the Wasp Nest"
evt.map[501] = function()
	evt.MoveToMap{X = 14350, Y = -6955, Z = 0, Direction = 640, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "out03.odm"}
end

evt.hint[502] = evt.str[1]  -- "Leave the Wasp Nest"
evt.map[502] = function()
	evt.MoveToMap{X = 16390, Y = -4941, Z = 433, Direction = 1280, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "out03.odm"}
end

evt.hint[503] = evt.str[1]  -- "Leave the Wasp Nest"
evt.map[503] = function()
	evt.MoveToMap{X = 0, Y = 0, Z = 0, Direction = 0, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end
