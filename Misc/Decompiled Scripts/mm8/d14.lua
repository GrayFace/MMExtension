...
evt.map[9] = function()  -- function events.LeaveMap()
	evt.ForPlayer("All")
	if evt.Cmp("Inventory", 627) then         -- "Remains of Korbu"
		evt.Set("QBits", 219)         -- Remains of Korbu - I lost it
	end
end
...
evt.map[10] = function()  -- function events.LeaveMap()
	if not evt.Cmp("QBits", 81) then         -- Found the Sarcophagus of Korbu
		evt.ForPlayer("All")
		if evt.Cmp("Inventory", 612) then         -- "Sarcophagus of Korbu"
			if evt.Cmp("Inventory", 627) then         -- "Remains of Korbu"
				evt.Add("QBits", 81)         -- Found the Sarcophagus of Korbu
			end
		end
	end
end
...
evt.map[101] = function()
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 25, FromX = -2176, FromY = -4432, FromZ = 896, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
	evt.CastSpell{Spell = 15, Mastery = const.GM, Skill = 25, FromX = -1536, FromY = -4432, FromZ = 896, ToX = -1, ToY = -1, ToZ = -1}         -- "Sparks"
end

evt.hint[102] = evt.str[100]  -- ""
evt.map[102] = function()
	evt.CastSpell{Spell = 2, Mastery = const.GM, Skill = 30, FromX = -4380, FromY = -5344, FromZ = -848, ToX = -4004, ToY = -5344, ToZ = -848}         -- "Fire Bolt"
	evt.CastSpell{Spell = 2, Mastery = const.GM, Skill = 30, FromX = -4004, FromY = -5344, FromZ = -848, ToX = -4380, ToY = -5344, ToZ = -848}         -- "Fire Bolt"
end

evt.hint[103] = evt.str[100]  -- ""
evt.map[103] = function()
	evt.CastSpell{Spell = 2, Mastery = const.GM, Skill = 30, FromX = -4380, FromY = -5600, FromZ = -848, ToX = -4004, ToY = -5600, ToZ = -848}         -- "Fire Bolt"
	evt.CastSpell{Spell = 2, Mastery = const.GM, Skill = 30, FromX = -4004, FromY = -5600, FromZ = -848, ToX = -4380, ToY = -5600, ToZ = -848}         -- "Fire Bolt"
end

evt.hint[104] = evt.str[100]  -- ""
evt.map[104] = function()
	evt.CastSpell{Spell = 2, Mastery = const.GM, Skill = 30, FromX = -4380, FromY = -5856, FromZ = -848, ToX = -4004, ToY = -5856, ToZ = -848}         -- "Fire Bolt"
	evt.CastSpell{Spell = 2, Mastery = const.GM, Skill = 30, FromX = -4004, FromY = -5856, FromZ = -848, ToX = -4380, ToY = -5856, ToZ = -848}         -- "Fire Bolt"
	evt.CastSpell{Spell = 2, Mastery = const.GM, Skill = 30, FromX = -4380, FromY = -5984, FromZ = -848, ToX = -4004, ToY = -5984, ToZ = -848}         -- "Fire Bolt"
	evt.CastSpell{Spell = 2, Mastery = const.GM, Skill = 30, FromX = -4004, FromY = -5984, FromZ = -848, ToX = -4380, ToY = -5984, ToZ = -848}         -- "Fire Bolt"
end

evt.hint[501] = evt.str[1]  -- "Leave the Cyclops Larder"
evt.map[501] = function()
	evt.MoveToMap{X = 14045, Y = -18343, Z = 641, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out04.odm"}
end
