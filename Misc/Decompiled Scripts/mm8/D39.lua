local TXT = Localize{
	[0] = " ",
	[1] = "Leave the Prison of the Lord of Earth",
	[2] = "Door",
	[3] = "Chest",
	[4] = "Lever",
	[5] = "Button",
...
evt.HouseDoor(201, 441)  -- "Earth Lord's Cell"
evt.hint[451] = evt.str[100]  -- ""
evt.map[451] = function()
	evt.MoveToMap{X = 47, Y = -76, Z = 1, Direction = 0, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end

evt.hint[452] = evt.str[100]  -- ""
evt.map[452] = function()
	evt.MoveToMap{X = 64, Y = 448, Z = -3008, Direction = -1, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end

evt.hint[453] = evt.str[100]  -- ""
evt.map[453] = function()
	evt.MoveToMap{X = -1, Y = 211, Z = -3519, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end

evt.hint[501] = evt.str[1]  -- "Leave the Prison of the Lord of Earth"
evt.map[501] = function()
	evt.MoveToMap{X = 13858, Y = -19595, Z = 1, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "pbp.odm"}
end
