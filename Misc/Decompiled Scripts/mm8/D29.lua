...
evt.map[451] = function()
	evt.MoveToMap{X = -2016, Y = 3840, Z = 1056, Direction = 0, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end

evt.hint[452] = evt.str[100]  -- ""
evt.map[452] = function()
	evt.MoveToMap{X = 544, Y = 3296, Z = 2336, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end

evt.hint[453] = evt.str[100]  -- ""
evt.map[453] = function()
	evt.MoveToMap{X = 2784, Y = 3840, Z = -244, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end

evt.hint[454] = evt.str[100]  -- ""
evt.map[454] = function()
	evt.MoveToMap{X = 2784, Y = 3840, Z = 1056, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "0"}
end

evt.hint[501] = evt.str[1]  -- "Leave the Castle of Fire"
evt.map[501] = function()
	evt.MoveToMap{X = -13338, Y = 16326, Z = 3841, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "ElemF.odm"}
end
