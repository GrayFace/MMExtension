local TXT = Localize{
	[0] = " ",
	[1] = "Leave the Grand Temple of Eep",
	[2] = "Door",
	[3] = "Chest",
	[4] = "Lever",
	[5] = "Button",
...
::_15::
	...
	do return end
::_14::
	evt.StatusText(10)         -- "You found nothing useful"
	goto _15
end

evt.hint[501] = evt.str[1]  -- "Leave the Grand Temple of Eep"
evt.map[501] = function()
	evt.MoveToMap{X = 20791, Y = 12317, Z = 2560, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "out05.odm"}
end
