...
evt.hint[501] = evt.str[1]  -- "Leave the Castle Air"
evt.map[501] = function()
	evt.MoveToMap{X = -11771, Y = -9444, Z = 3234, Direction = 2040, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "ElemA.odm"}
end
