...
evt.map[101] = function()
	evt.CastSpell{Spell = 6, Mastery = const.GM, Skill = 10, FromX = -8824, FromY = 5456, FromZ = 48, ToX = 0, ToY = 0, ToZ = 0}         -- "Fireball"
	evt.CastSpell{Spell = 6, Mastery = const.GM, Skill = 10, FromX = -8680, FromY = 5456, FromZ = 48, ToX = 0, ToY = 0, ToZ = 0}         -- "Fireball"
	evt.CastSpell{Spell = 6, Mastery = const.GM, Skill = 10, FromX = -8824, FromY = 5456, FromZ = -88, ToX = 0, ToY = 0, ToZ = 0}         -- "Fireball"
	evt.CastSpell{Spell = 6, Mastery = const.GM, Skill = 10, FromX = -8680, FromY = 5456, FromZ = -88, ToX = 0, ToY = 0, ToZ = 0}         -- "Fireball"
end

evt.hint[501] = evt.str[1]  -- "Leave the Chain of Fire"
evt.map[501] = function()
	evt.MoveToMap{X = -3632, Y = 18166, Z = 0, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out04.odm"}
end

evt.hint[502] = evt.str[1]  -- "Leave the Chain of Fire"
evt.map[502] = function()
	evt.MoveToMap{X = 8236, Y = 19211, Z = 1, Direction = 0, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out04.odm"}
end
