local TXT = Localize{
	[0] = " ",
	[1] = "Leave the Barbarian Fortress",
	[2] = "Door",
	[3] = "Chest",
	[4] = "Lever",
	[5] = "Button",
...
evt.map[6] = function()  -- function events.LeaveMap()
	if not evt.Cmp("QBits", 204) then         -- Dragon Leader's Egg - I lost it, taken event g49, g64
		evt.ForPlayer("All")
		if evt.Cmp("Inventory", 605) then         -- "Dragon Leader's Egg"
			evt.Set("QBits", 204)         -- Dragon Leader's Egg - I lost it, taken event g49, g64
		end
	end
end
...
evt.hint[501] = evt.str[1]  -- "Leave the Barbarian Fortress"
evt.map[501] = function()
	evt.MoveToMap{X = -19274, Y = 7911, Z = 2401, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out08.odm"}
end

evt.hint[502] = evt.str[1]  -- "Leave the Barbarian Fortress"
evt.map[502] = function()
	evt.MoveToMap{X = -19274, Y = 12329, Z = 2401, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out08.odm"}
end

evt.hint[503] = evt.str[1]  -- "Leave the Barbarian Fortress"
evt.map[503] = function()
	evt.MoveToMap{X = -14535, Y = 12425, Z = 2401, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out08.odm"}
end

evt.hint[504] = evt.str[1]  -- "Leave the Barbarian Fortress"
evt.map[504] = function()
	evt.MoveToMap{X = -14552, Y = 7911, Z = 2401, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out08.odm"}
end
