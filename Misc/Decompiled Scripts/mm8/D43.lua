local TXT = Localize{
	[0] = " ",
	[1] = "Leave the Ancient Troll Home",
	[2] = "Door",
	[3] = "Chest",
	[4] = "Lever",
	[5] = "Button",
	...
	[28] = "",
	[29] = "",
	[30] = "You have Killed all of the Basilisks in this Ancient Troll Home",
}
...
evt.map[10] = function()  -- function events.LeaveMap()
	if not evt.Cmp("QBits", 69) then         -- Ancient Troll Homeland Found
		if evt.CheckMonstersKilled{CheckType = 2, Id = 87, Count = 0, InvisibleAsDead = 1} then
			if evt.CheckMonstersKilled{CheckType = 2, Id = 88, Count = 0, InvisibleAsDead = 1} then
				if evt.CheckMonstersKilled{CheckType = 2, Id = 89, Count = 0, InvisibleAsDead = 1} then
					...
					evt.StatusText(30)         -- "You have Killed all of the Basilisks in this Ancient Troll Home"
				end
			end
		end
	end
...
evt.hint[501] = evt.str[1]  -- "Leave the Ancient Troll Home"
evt.map[501] = function()
	evt.MoveToMap{X = -20346, Y = 480, Z = 187, Direction = 0, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "out07.odm"}
end
