...
evt.hint[131] = evt.str[10]  -- "Talk to the Arena Master"
...
evt.hint[501] = evt.str[1]  -- "Leave the Arena"
evt.map[501] = function()
	evt.MoveToMap{X = 17091, Y = -12524, Z = 1, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "out02.odm"}
end
