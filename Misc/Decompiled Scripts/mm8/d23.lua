...
evt.map[101] = function()
	evt.CastSpell{Spell = 32, Mastery = const.GM, Skill = 20, FromX = 1334, FromY = 1354, FromZ = 203, ToX = 0, ToY = 0, ToZ = 0}         -- "Ice Blast"
end

evt.hint[102] = evt.str[100]  -- ""
evt.map[102] = function()
	evt.CastSpell{Spell = 32, Mastery = const.GM, Skill = 20, FromX = -886, FromY = 1354, FromZ = 203, ToX = 0, ToY = 0, ToZ = 0}         -- "Ice Blast"
end

evt.hint[103] = evt.str[100]  -- ""
evt.map[103] = function()
	evt.CastSpell{Spell = 32, Mastery = const.GM, Skill = 20, FromX = -886, FromY = 3574, FromZ = 203, ToX = 0, ToY = 0, ToZ = 0}         -- "Ice Blast"
end

evt.hint[104] = evt.str[100]  -- ""
evt.map[104] = function()
	evt.CastSpell{Spell = 32, Mastery = const.GM, Skill = 20, FromX = 1334, FromY = 3574, FromZ = 203, ToX = 0, ToY = 0, ToZ = 0}         -- "Ice Blast"
end
...
evt.hint[501] = evt.str[1]  -- "Leave the Druid Circle"
evt.map[501] = function()
	evt.MoveToMap{X = 17424, Y = 10760, Z = 577, Direction = 0, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "Out07.odm"}
end
