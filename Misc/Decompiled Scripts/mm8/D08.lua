local TXT = Localize{
	...
	[38] = "",
	[39] = "",
	[40] = "You have killed all of the Dire Wolves",
}
			...
			if evt.CheckMonstersKilled{CheckType = 2, Id = 85, Count = 0, InvisibleAsDead = 0} then
				if evt.CheckMonstersKilled{CheckType = 2, Id = 86, Count = 0, InvisibleAsDead = 0} then
					if evt.Cmp("QBits", 141) then         -- Dire Wolf Questbit for Riki
						...
						evt.StatusText(40)         -- "You have killed all of the Dire Wolves"
						...
						evt.SummonMonsters{TypeIndexInMapStats = 1, Level = 1, Count = 222, X = -2134, Y = 1, Z = 0, NPCGroup = 1, unk = 0}         -- "Peasants on Main Island of Dagger Wound"
...
evt.hint[501] = evt.str[1]  -- "Leave the Dire Wolf Den"
evt.map[501] = function()
	evt.MoveToMap{X = -20372, Y = 16365, Z = 2, Direction = 0, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 1, Name = "out02.odm"}
end
