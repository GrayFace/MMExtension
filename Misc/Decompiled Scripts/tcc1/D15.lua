...
evt.MazeInfo = evt.str[16]  -- "The Barracks Keep"
...
evt.map[53] = function()  -- function events.LoadMap()
	if not evt.Cmp("QBits", 482) then         -- The Barracks Once
		evt.SummonMonsters{TypeIndexInMapStats = 3, Level = 1, Count = 5, X = -495, Y = 2146, Z = 0}
		evt.SummonMonsters{TypeIndexInMapStats = 3, Level = 2, Count = 3, X = 1898, Y = 2289, Z = 0}
		evt.SummonMonsters{TypeIndexInMapStats = 3, Level = 2, Count = 3, X = 2072, Y = 4685, Z = 0}
		evt.SummonMonsters{TypeIndexInMapStats = 3, Level = 3, Count = 2, X = 2026, Y = 6570, Z = 0}
		evt.SummonMonsters{TypeIndexInMapStats = 3, Level = 2, Count = 3, X = -1912, Y = 2298, Z = 0}
		evt.SummonMonsters{TypeIndexInMapStats = 3, Level = 1, Count = 4, X = -2067, Y = 4067, Z = 0}
		evt.SummonMonsters{TypeIndexInMapStats = 3, Level = 3, Count = 2, X = -2008, Y = 6513, Z = 0}
		evt.SummonMonsters{TypeIndexInMapStats = 3, Level = 1, Count = 4, X = -686, Y = 7283, Z = 0}
		evt.SummonMonsters{TypeIndexInMapStats = 2, Level = 3, Count = 1, X = -4243, Y = 1997, Z = 0}
		evt.SummonMonsters{TypeIndexInMapStats = 3, Level = 1, Count = 4, X = 1075, Y = 8147, Z = 0}
		evt.SummonMonsters{TypeIndexInMapStats = 2, Level = 3, Count = 1, X = 4221, Y = 2133, Z = 0}
		evt.SummonMonsters{TypeIndexInMapStats = 3, Level = 2, Count = 6, X = -24, Y = 8857, Z = 0}
		evt.Set("QBits", 482)         -- The Barracks Once
		evt.ForPlayer("All")
		evt.Subtract("Inventory", 490)         -- "Barracks Key"
	end
end

events.LoadMap = evt.map[53].last
