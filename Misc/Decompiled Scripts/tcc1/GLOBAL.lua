...
Good Luck!" ]]
	...
	evt.Add("QBits", 509)         -- Mini Me Once
	i = Game.Rand() % 6
	if i == 1 or i == 2 then
		evt.MoveNPC{NPC = 162, HouseId = 106}         -- "Dexter  D. Fraud" -> "Rockham's Pride"
		evt.MoveNPC{NPC = 104, HouseId = 117}         -- "Thomas A. Varice" -> "Secure Trust"
...
Oh!  I can also heal your party of all wounds while we travel, but I can only perform this service twice.  So use me sparingly.  Let’s get going, ok?”" ]]
	evt.Set("Food", 0)
	evt.Set("QBits", 83)         -- "Escourt Tobin back to the Misty Island Temple."
...
Now to the proposition.  My former associates, in a most uncharitable act, procured two items of treasure from me.  I would like you to 'reacquire' them for me.  These items are the Sorcerer’s Eye and the Jeweled Egg. I know one is hidden in Tortuga Hall, and the other I have heard is hidden somewhere in the Abandoned Temple.  If you manage to get them bring them to me for your reward." ]]
	evt.Set("QBits", 84)         -- "Recover the Sorcerer’s Eye and the Jeweled Egg, and return them to Aithei Taeyalme  in Sutter's Bay."
...
evt.global[10] = function()
	...
	if evt.Cmp("Inventory", 480) then         -- "Jeweled Egg"
		if evt.Cmp("Inventory", 446) then         -- "Sorcerer's Eye"
			...
			evt.Subtract("QBits", 84)         -- "Recover the Sorcerer’s Eye and the Jeweled Egg, and return them to Aithei Taeyalme  in Sutter's Bay."
			evt.Add("Awards", 1)         -- "Retrieved items for Aithei Taeyalme"
...
evt.global[11] = function()
	...
	evt.Set("QBits", 88)         -- "Deliver report to Svarktel in Jorgsborg."
...
True, well our employers are looking to branch out and we are always on the lookout for good help.  I need to see if you have what it takes.  There is an artifact that has special significance to my employer.  They want the Crystal of Mana, and will pay a sizable sum for its retrieval.  You are not the first I’ve sent to find it.  The last one thought he was on the right track.  His body was found in The Underground by one of my operatives, this key was found among his possessions.  Maybe it’s important, maybe not.  Bring me the crystal and I’ll pay you well." ]]
		...
		evt.Subtract("QBits", 88)         -- "Deliver report to Svarktel in Jorgsborg."
		evt.Add("Awards", 4)         -- "Delivered Journal to Svarktel"
		evt.Add("Gold", 1000)
		evt.Add("Experience", 5000)
		evt.SetNPCTopic{NPC = 353, Index = 0, Event = 49}         -- "Svarktel Jorgen" : "Crystal of Mana"
		evt.Set("QBits", 124)         -- "Return the Crystal of Mana to Svartkel Jorgen in Jorgsborg."
		evt.ForPlayer("Current")
...
evt.global[13] = function()
	...
	evt.Add("QBits", 96)         -- "Enter the Den of Iniquity in Port Sleigon, recover the Sacred Chalice and return to Lord Godwinson."
...
evt.global[14] = function()
	...
	evt.Subtract("QBits", 96)         -- "Enter the Den of Iniquity in Port Sleigon, recover the Sacred Chalice and return to Lord Godwinson."
...
evt.global[15] = function()
	if evt.Cmp("Awards", 7) then         -- "Destroyed the Norse Lair"
		...
		evt.Add("QBits", 98)         -- "Clear out the Mercenary Stronghold in Port Sleigon, kill their leader and return Krukow’s Armor to Lord Godwinson."
...
evt.global[16] = function()
	...
	evt.Subtract("QBits", 98)         -- "Clear out the Mercenary Stronghold in Port Sleigon, kill their leader and return Krukow’s Armor to Lord Godwinson."
	evt.ForPlayer(0)
...
Tamara, please remain here.  I have something else in mind for you."" ]]
	...
	evt.Set("QBits", 85)         -- "Enter Castle Birka in Demonclaw and talk with Lord Godwinson."
	evt.ForPlayer("Current")
...
evt.global[21] = function()
	...
	evt.Subtract("QBits", 85)         -- "Enter Castle Birka in Demonclaw and talk with Lord Godwinson."
...
evt.global[22] = function()
	...
	if evt.Cmp("QBits", 485) then         -- LG 2nd Jorgsburg
		evt.Subtract("QBits", 86)         -- "Raise the siege of Birka and secure Jorgsburg."
		evt.Add("Experience", 5000)
...
Well done, adventurers!  I hereby release you from your service and declare you the Saviors of Demonclaw!  Keep the sword as a fitting reward for your service not only to me, but to the people of the Demonclaw, as well.  You are always welcome here.  " ]]
		evt.Subtract("QBits", 87)         -- "Bring the Sword of Grish'nak to Lord Godwinson."
		evt.ForPlayer("All")
		evt.Add("Experience", 40000)
		evt.Add("Awards", 3)         -- "Saviors of Demonclaw"
		evt.Add("Gold", 2500)
		...
		if evt.Cmp("QBits", 87) then         -- "Bring the Sword of Grish'nak to Lord Godwinson."
...
Good luck adventurers!" ]]
			evt.Set("QBits", 87)         -- "Bring the Sword of Grish'nak to Lord Godwinson."
			evt.ForPlayer("Current")
...
evt.global[26] = function()
	...
	if evt.Cmp("Inventory", 448) then         -- "Talisman of Life"
		...
		evt.Add("Experience", 15000)
		evt.Set("Awards", 5)         -- "Destroyed Lufkta and recovered Talisman"
		evt.Subtract("QBits", 89)         -- "Find and destroy Luftka.  Return Talisman to Zu'l in Port Sleigon"
		evt.SetNPCTopic{NPC = 6, Index = 1, Event = 65}         -- "Zeddicus Z'ul The Fifth" : "Battle Ragers"
	else
		if evt.Cmp("QBits", 89) then         -- "Find and destroy Luftka.  Return Talisman to Zu'l in Port Sleigon"
...
Go!" ]]
			evt.Set("QBits", 89)         -- "Find and destroy Luftka.  Return Talisman to Zu'l in Port Sleigon"
		end
	end
end
...
Return to me after the delivery and I will keep my eyes open for strange events in Nimradur. " ]]
	evt.Set("QBits", 95)         -- "Deliver the letter to Gilbert Hammer on the Mystic Isles and return to Lady Kathryn in Avalon."
...
Return to me after you have their trust." ]]
	evt.Set("QBits", 90)         -- "Gain the trust of the  Lords and The Ladies of Nimradur.  Then return to The Seer in Kat'an."
	evt.SetNPCTopic{NPC = 9, Index = 1, Event = 0}         -- "The Seer"
	evt.ForPlayer("Current")
...
Good luck adventurers!" ]]
	evt.ForPlayer("All")
	evt.Subtract("QBits", 90)         -- "Gain the trust of the  Lords and The Ladies of Nimradur.  Then return to The Seer in Kat'an."
	evt.Add("Awards", 32)         -- "Gained the trust of the Lords and Ladies"
	evt.SetNPCTopic{NPC = 9, Index = 1, Event = 0}         -- "The Seer"
...
Hurry!   … before it is too late!" ]]
	evt.Set("QBits", 110)         -- "Purge the Temple of Tranquility west of Avalon and return the Bell of Summoning to Lady Kathryn in The Citadel."
...
Your journey will be difficult and fraught with great perils.  The clerics have established their temple on an isolated island in The Far Reaches, at the ends of our lands.  Travel to this temple, deface the Idols of Chaos, and kill these perverted worshippers. Then we’ll deal with The Lords of Chaos." ]]
	evt.Set("QBits", 125)         -- "Deface  the Idols in the Temple of Chaos, destroy the inhabitants, and return to The Seer."
	evt.SetNPCTopic{NPC = 9, Index = 1, Event = 0}         -- "The Seer"
end
...
Return to me when you have the jewel." ]]
	evt.Set("QBits", 131)         -- "Find the Jewel of Power in the Fortress of the Ancients in Norseland.  Then return to the Seer."
...
evt.global[34] = function()
	...
	if evt.Cmp("Inventory", 481) then         -- "Jewel of Power"
		...
		evt.Subtract("QBits", 131)         -- "Find the Jewel of Power in the Fortress of the Ancients in Norseland.  Then return to the Seer."
		evt.Add("ReputationIs", 500)
		evt.Add("Awards", 42)         -- "Retrieved the Jewel of Power"
...
Once you have accomplished this, return to me." ]]
	evt.Add("QBits", 105)         -- "Find and judge (1) Avarice, (2) Oppression, (3) Adultery, (4) Lying, and  (5) Self-Righteousness.   Then return to King Jaffar in Kat'an."
...
Therefore, I hereby promote all Priests to Inquisitors, and all others to Honorary Inquisitors." ]]
				evt.Subtract("QBits", 105)         -- "Find and judge (1) Avarice, (2) Oppression, (3) Adultery, (4) Lying, and  (5) Self-Righteousness.   Then return to King Jaffar in Kat'an."
...
Good  Luck, Inquisitors." ]]
		evt.Add("QBits", 107)         -- "Purge the Disordered Sanctum in Norseland and return to King Jaffar with the Cloak of the High Priestess."
...
You have served The Realm well this day, adventurers.  By the power invested in me as both King of Nimradur and High Exorcist of The Realm, I hereby promote all Inquisitors amoung you to Exorcists, and all others to Honorary Exorcist. " ]]
	...
	evt.Subtract("QBits", 107)         -- "Purge the Disordered Sanctum in Norseland and return to King Jaffar with the Cloak of the High Priestess."
	evt.ForPlayer("All")
	evt.Add("Experience", 30000)
...
evt.global[47] = function()
	...
	evt.Add("QBits", 113)         -- "Find the Horn of Vainen, open the portal doors in Orpheus’s Gateway, and return to Danika in the Bog."
...
evt.global[48] = function()
	if evt.Cmp("QBits", 454) then         -- Opened the Gateway
		...
		evt.ForPlayer("All")
		evt.Subtract("QBits", 113)         -- "Find the Horn of Vainen, open the portal doors in Orpheus’s Gateway, and return to Danika in the Bog."
		evt.Add("Awards", 35)         -- "Freed the souls of the Undead Virgins"
...
evt.global[49] = function()
	if evt.Cmp("Inventory", 457) then         -- "Crystal of Mana"
		...
		evt.ForPlayer("All")
		evt.Subtract("QBits", 124)         -- "Return the Crystal of Mana to Svartkel Jorgen in Jorgsborg."
		evt.Subtract("Inventory", 457)         -- "Crystal of Mana"
		evt.Add("Awards", 37)         -- "Delivered Crystal of Mana to Svarktel"
		evt.Add("Gold", 1250)
		evt.Add("Experience", 5000)
...
Since you have served me well in delivering the letter, I will join your cause and be watchful." ]]
		evt.Add("Experience", 15000)
		evt.Set("Awards", 6)         -- "Delivered letter to Gilbert Hammer"
		evt.Subtract("QBits", 95)         -- "Deliver the letter to Gilbert Hammer on the Mystic Isles and return to Lady Kathryn in Avalon."
		evt.Add("ReputationIs", 100)
...
You can read more about these principles in my book “How to Fleece the Flock”." ]]
	if evt.Cmp("QBits", 105) then         -- "Find and judge (1) Avarice, (2) Oppression, (3) Adultery, (4) Lying, and  (5) Self-Righteousness.   Then return to King Jaffar in Kat'an."
...
Please hurry and retrieve my Staff so I can get on with my work without being bothered and you can get on with your adventuring as newly promoted Enchanters." ]]
	evt.Add("QBits", 111)         -- "Find the Staff of Merlin in the Ooze Pit in Kastutia and return to Soiret the Adept in the Enchanted Bastion."
...
So you still have not found my Staff of Merlin? I hoped to have it back by now. Please continue your search and bring me my Staff! You cannot be promoted to Enchanter until this task is completed." ]]
	...
	evt.Add("ReputationIs", 50)
	evt.Subtract("QBits", 111)         -- "Find the Staff of Merlin in the Ooze Pit in Kastutia and return to Soiret the Adept in the Enchanted Bastion."
...
To be promoted to the high level of Adept, you must travel to the Halls of the Adept in Kastutia. Find the hidden cave complex within where a pair of Blue Torches are located. If you activate both torches, you will be transported to the Fountain of Enchantment. Drink from this fountain and return to me. Here, you may need this Scroll of Walk on Water to complete the journey." ]]
		evt.ForPlayer("All")
		evt.Add("QBits", 126)         -- "Drink from the Fount of Enchantment and then return to Soiret in the Enchanted Bation (Start from Halls of the Adept in Kastutia)"
...
[With a wave of his wand and a few mysterious words, Soiret declares]  "I hereby promote all Enchanters to Adept and all Honorary Enchanters to Honorary Adept." ]]
	...
	evt.Add("ReputationIs", 100)
	evt.Subtract("QBits", 126)         -- "Drink from the Fount of Enchantment and then return to Soiret in the Enchanted Bation (Start from Halls of the Adept in Kastutia)"
	evt.ForPlayer("All")
	evt.Subtract("Inventory", 457)         -- "Crystal of Mana"
	evt.Subtract("QBits", 126)         -- "Drink from the Fount of Enchantment and then return to Soiret in the Enchanted Bation (Start from Halls of the Adept in Kastutia)"
...
Good Luck!" ]]
	evt.ForPlayer("All")
	evt.Set("QBits", 163)         -- "Return to Lord Godwinson in Castle Birka with the Norse invasion plans.."
...
Go to Kastuia.  Find Lunatic Vault.  Enter.  You conquer fears there!  Touch Flame of Might and return to Z’ul.  He’ll then promote you Battlerager." ]]
	evt.Add("QBits", 114)         -- "Enter the Lunatic Vault in Kastution Waters, touch the Flame of Might, and return to Zeddicus the Fifth in Port Sleigon"
...
evt.global[68] = function()
	if not evt.Cmp("QBits", 112) then         -- "Return with the Royal Land Grant to Jack Slagg in Kat'an."
		...
		evt.Set("QBits", 112)         -- "Return with the Royal Land Grant to Jack Slagg in Kat'an."
		evt.ForPlayer("Current")
		...
		if evt.Cmp("Inventory", 505) then         -- "Royal Land Grant "
			...
			evt.Add("Awards", 34)         -- "Returned the King’s Land Grant to Jack Slagg"
			evt.Add("Experience", 5000)
			evt.SetNPCTopic{NPC = 77, Index = 0, Event = 0}         -- "Jack Slagg"
			evt.Subtract("Inventory", 504)         -- "Mabon’s Cave"
			evt.Subtract("QBits", 112)         -- "Return with the Royal Land Grant to Jack Slagg in Kat'an."
			evt.Add("Gold", 1250)
		else
...
Good.  You no more fear.  You mighty.  Courage found.  You Battleragers now." ]]
	evt.Subtract("QBits", 114)         -- "Enter the Lunatic Vault in Kastution Waters, touch the Flame of Might, and return to Zeddicus the Fifth in Port Sleigon"
	evt.Add("ReputationIs", 50)
	evt.ForPlayer("All")
	evt.Add("Experience", 15000)
	evt.ForPlayer(0)
...
Go now!" ]]
		evt.Add("QBits", 115)         -- "Find Agnitum amoung the Tent People and then return to Z'ul in Port Sleigon."
...
[You kneel before Sir Zeddicus Z’ul the Fifth as he touches your shoulder with his blade and pronounces you Doom Knights of The Realm!]" ]]
	...
	evt.Add("ReputationIs", 100)
	evt.Subtract("QBits", 115)         -- "Find Agnitum amoung the Tent People and then return to Z'ul in Port Sleigon."
	evt.ForPlayer("All")
	evt.Add("Experience", 40000)
...
evt.global[76] = function()
	...
	if evt.Cmp("Inventory", 534) then         -- "Norse Invasion Plans"
		...
		evt.Subtract("QBits", 163)         -- "Return to Lord Godwinson in Castle Birka with the Norse invasion plans.."
		evt.Set("QBits", 120)         -- "Destroy the Norse Lair and return the flute to Lord Godwinson in Castle Burka."
...
Good luck my friends." ]]
		evt.Subtract("QBits", 120)         -- "Destroy the Norse Lair and return the flute to Lord Godwinson in Castle Burka."
...
I do have a third alternative to finding these ingredients.  There is a merchant named Trader Joe who dwells among the tent people of Baal’s Garden.  You may be able to purchase these potions from him.  But be warned, he charges exorbitant prices for his wares!" ]]
	evt.Set("QBits", 138)         -- "Return to Aelwen in Avalon  with a Personality Potion and an Intellect Potion."
	evt.ForPlayer("Current")
...
Georgeton was furious when he came home - with that horrible axe, he killed Wilkit. One chop - and his head fell to the floor. Blood splattered everywhere. Georgeton, just looked at me painfully and left forever. Is it my fault that Georgeton went mad and left because of a meaningless rendezvous?" ]]
	evt.Add("QBits", 116)         -- "Return to Lord Godwinson in Castle Birka with the Norse invasion plans."
	evt.Set(216, 0)
...
evt.global[80] = function()
	...
	evt.Subtract("QBits", 116)         -- "Return to Lord Godwinson in Castle Birka with the Norse invasion plans."
	evt.Subtract("ReputationIs", 200)
	evt.ForPlayer("All")
	evt.Add("Awards", 6)         -- "Delivered letter to Gilbert Hammer"
	evt.Add("Experience", 25000)
	evt.SetNPCTopic{NPC = 14, Index = 0, Event = 81}         -- "Lady Kathryn" : "Money"
	evt.ForPlayer("All")
	if evt.Cmp("Awards", 32) then         -- "Gained the trust of the Lords and Ladies"
		if evt.Cmp("Awards", 2) then         -- "Resued Tamara"
			if evt.Cmp("Awards", 3) then         -- "Saviors of Demonclaw"
				if evt.Cmp("Awards", 4) then         -- "Delivered Journal to Svarktel"
...
Finding and obtaining the Last Rose of Winter may well be a treacherous journey indeed, for it only grows in the high snowy altitudes of Demonclaw, not easily accessible by foot. Therefore, I give you this Scroll of Fly to assist you in reaching those heights. Return to me as soon as you have found the Last Rose of Winter. I would be eternally grateful and delighted to welcome all of you into the great family of Sylvans … and please be sure to dress warmly my dears." ]]
	evt.Add("QBits", 118)         -- "Return with the Last Rose of Winter to Baronness Klaravoiya in Avalon."
	evt.ForPlayer("Current")
...
Drink from the Creations Fount so you can better understand how to protect the forests and all life in Nimradur. Then when your Mind's Eye is enlightened to the wonders of Nature, return to me and I will promote all Sylvans to Elder and all honorary Sylvans to honorary Elders." ]]
		evt.Add("QBits", 119)         -- "Drink from Creations Fount and return to Klaravoiya."
...
evt.global[87] = function()
	...
	evt.Add("QBits", 120)         -- "Destroy the Norse Lair and return the flute to Lord Godwinson in Castle Burka."
...
evt.global[88] = function()
	...
	if evt.Cmp("Inventory", 461) then         -- "Bell of Summoning"
		evt.ForPlayer("All")
		evt.Subtract("QBits", 110)         -- "Purge the Temple of Tranquility west of Avalon and return the Bell of Summoning to Lady Kathryn in The Citadel."
...
Quickly now, my friends.  Begone!" ]]
		evt.Set("Awards", 33)         -- "Declared Friends of The Sisterhood"
...
evt.global[90] = function()
	if evt.Cmp("QBits", 131) then         -- "Find the Jewel of Power in the Fortress of the Ancients in Norseland.  Then return to the Seer."
...
evt.global[91] = function()
	...
	evt.Add("QBits", 121)         -- "Go to Wrenford's Retreat in the Kastution Waters, free the Crystal of Accuracy, and return to Lady Kathryn in The Citadel."
...
Leave me at once before I reconsider the quest and your chance at promotion." ]]
	...
	evt.Subtract("QBits", 121)         -- "Go to Wrenford's Retreat in the Kastution Waters, free the Crystal of Accuracy, and return to Lady Kathryn in The Citadel."
	evt.Add("ReputationIs", 50)
	evt.ForPlayer("All")
	evt.Add("Experience", 30000)
...
Back so soon?  You were only promoted to Marksman a short time ago.  It usually takes almost a decade to earn promotion to stalker.  You however are in luck, I do have a task that has needed my attention for sometime; the Bow of Artemis was recently found by some of my informants.  They report that it is hidden in the Cavern of Timbol.  Unfortunately the creatures inside the cavern are far too strong for them to deal with.  Bring me the bow and I will overlook your inexperience and promote the Marksman to Stalker and as before the rest will be given an honorary title." ]]
		evt.Add("QBits", 122)         -- "Go to the Cavern of Timbol in Kat'an, retrieve the Bow of Artemis, and return to Lady Kathryn in The Citadel."
...
I knew it was a mistake to fast track your party to promotion, but I have only myself to blame putting trust in a group of novices.  Go before I have the guards throw you out." ]]
	...
	evt.Add("ReputationIs", 100)
	evt.Subtract("QBits", 122)         -- "Go to the Cavern of Timbol in Kat'an, retrieve the Bow of Artemis, and return to Lady Kathryn in The Citadel."
	evt.ForPlayer("All")
	evt.Add("Experience", 50000)
	evt.ForPlayer(0)
...
evt.global[114] = function()
	...
	evt.Set("QBits", 141)         -- "Bring the Pearl of Turmoil to Mallt in Avalon."
	evt.SetNPCTopic{NPC = 37, Index = 0, Event = 299}         -- "Mallt" : "We've found the Pearl of Turmoil!"
end

-- "Lodestones"
evt.global[115] = function()
	evt.Set("AutonotesBits", 100)         -- "Davis Carp will buy lodestones for 5 gold each in Port Sleigon."
	evt.ForPlayer(0)
...
evt.global[116] = function()
	evt.Set("AutonotesBits", 101)         -- "Bonnie Rotterdam will buy feathers for 10 gold each in Port Sleigon."
	evt.ForPlayer(0)
...
evt.global[117] = function()
	evt.Set("AutonotesBits", 102)         -- "Renee Blackburn will buy pyramids for 1000 gold each in Port Sleigon."
	evt.ForPlayer(0)
...
evt.global[118] = function()
	evt.Set("AutonotesBits", 103)         -- "Nick Fenstar will buy kegs of wine for 300 gold each in Port Sleigon."
	evt.ForPlayer(0)
	if evt.Cmp("Inventory", 473) then         -- "Keg of Wine"
		evt.Subtract("Inventory", 473)         -- "Keg of Wine"
		evt.Add("Gold", 300)
...
evt.global[119] = function()
	...
	evt.Set("QBits", 128)         -- "Recover the Bronze skull from the Forbidden Vault and return to Magnus."
...
evt.global[120] = function()
	evt.Set("AutonotesBits", 105)         -- "Geoff Southy will buy clovers for 25 gold each in Port Sleigon."
	evt.ForPlayer(0)
...
evt.global[121] = function()
	...
	if evt.Cmp("Inventory", 469) then         -- "Bronze Skull"
		...
		evt.Subtract("QBits", 128)         -- "Recover the Bronze skull from the Forbidden Vault and return to Magnus."
		evt.Set("QBits", 129)         -- "Find HodgePodge in Avalon and then recover the Gold and White skulls.  Return to Magnus with the skulls."
...
You must clear the skies of all witches, slay Morgana and her Hag Prophetess, and return with Morgana’s Ring.  Morgana draws more of these foul hags to herself by the hour, so time is of the essence or they will replace their losses rapidly.  Return to me once you have succeeded." ]]
	evt.Add("QBits", 204)         -- "Clear the skies of the Bog of Tuonela of all Witches and return to Hilda with Morgana’s Ring."
...
evt.global[123] = function()
	...
	if evt.Cmp("QBits", 451) then         -- 4-hour  timer for quest complete
		...
		evt.Add("Awards", 60)         -- "Defeated the Witches of Tuonela"
		evt.Add("Experience", 50000)
		evt.ForPlayer("Current")
		evt.Add("Gold", 5000)
		evt.Add("ReputationIs", 100)
		evt.Subtract("QBits", 204)         -- "Clear the skies of the Bog of Tuonela of all Witches and return to Hilda with Morgana’s Ring."
...
evt.global[135] = function()
	local i
	evt.Set("AutonotesBits", 107)         -- "Bandar Jahrom will trade gems for lamps in Abul's Desert Resort in Baal's Garden."
	evt.ForPlayer(0)
...
The Drow have become somewhat problematic as of late, and we have alarming reports coming from the Elves concerning them.  Please journey to Castle Birka and talk with Indis Nénharma, a regal Elf of high standing in her nation.  Obey her as you would me." ]]
					...
					evt.Subtract("Inventory", 469)         -- "Bronze Skull"
					evt.Subtract("Inventory", 466)         -- "Crystal Skull"
					evt.Subtract("QBits", 130)         -- "Enter Underwald in Sutter’s Bay, destroy the Drow presence, and return the four skulls to the Seer."
					evt.SetNPCTopic{NPC = 9, Index = 1, Event = 0}         -- "The Seer"
					evt.Add("Experience", 50000)
					evt.Add("Awards", 40)         -- "Destroyed the Drow presence in Sutter’s Bay."
					evt.Subtract("Inventory", 456)         -- "Amulet of Entrance"
					evt.Set("QBits", 165)         -- "Visit Indis Nénharma in Castke Birka."
...
evt.global[282] = function()
	evt.SetMessage(289)         -- "The smoothest talking merchant I've ever seen is Will Ottoman in Avalon.  If you're looking to improve your merchant skill, he's the man to see."
end
...
evt.global[287] = function()
	...
	if not evt.Cmp("Inventory", 447) then         -- "Gold Skull"
		...
		if evt.Cmp("Inventory", 464) then         -- "White Skull"
			...
			evt.Subtract("QBits", 129)         -- "Find HodgePodge in Avalon and then recover the Gold and White skulls.  Return to Magnus with the skulls."
...
It has been a pleasure doing business with you, but I doubt that our paths will ever cross again, goodbye." ]]
			evt.Add("Experience", 50000)
			evt.Add("Awards", 39)         -- "Delivered the four skulls to Magnus"
...
Rid the Underwald of the Drow presence, retrieve the skulls, and bring them to me.  Hurry!" ]]
	evt.Add("QBits", 130)         -- "Enter Underwald in Sutter’s Bay, destroy the Drow presence, and return the four skulls to the Seer."
...
evt.global[292] = function()
	evt.SetMessage(177)         --[[ "You have done well, my friends.  The Moment of Truth has arrived.  Now you must enter Creation’s Land through The Void.  The only access to The Void is through the Fortress of Anarchy, which resides in the Ether of Darkness.
...
Good luck!" ]]
	evt.Add("QBits", 134)         -- "Enter the Drow Hive in Glacier’s End, find the Ether Jewel, and activate the Ether  Portal."
	evt.SetNPCTopic{NPC = 9, Index = 1, Event = 0}         -- "The Seer"
end
...
Now it’s time to go through the portal.  Good luck, my friends!" ]]
	evt.Subtract("QBits", 134)         -- "Enter the Drow Hive in Glacier’s End, find the Ether Jewel, and activate the Ether  Portal."
	evt.Add("Awards", 43)         -- "Found the Ether Jewel and activated the Ether Portal."
	evt.ForPlayer("All")
	evt.Add("Experience", 500000)
	evt.Set("QBits", 136)         -- "Destroy The Fortress of Anarchy."
	evt.ForPlayer(0)
...
Unfortunately, if you ‘dispatch’ Koschei, he will simply return in time because his soul no longer resides in his body,but in a Soul Egg.  This egg is guarded by his ‘pet’ Falspar, a  Bone Dragon of terrible power.  So to qualify for the reward you must not only defeat Koschei but also acquire his Soul Egg from Falspar.  Slay Koschei and then return with his Soul Egg to me and the award will be yours." ]]
	evt.Set("QBits", 137)         -- "Slay Koschei the Deathless and return with his Soul Egg."
...
evt.global[295] = function()
	...
	if evt.Cmp("Inventory", 474) then         -- "Soul Egg"
		...
		evt.Subtract("QBits", 137)         -- "Slay Koschei the Deathless and return with his Soul Egg."
		evt.Add("Awards", 46)         -- "1,000,000 Exp Winner!"
...
[After disappearing in the back of the hut for a few moments, Aelwen returns holding a potion bottle.] Here is the Elixir of Wisdom.  I ask one more favor.  Enter the Temple of Agrona's Faithful make your way deep inside and apply the elixir to the altar inside the temple.  Once it has been applied, the leader of the cult will have her hold on her followers broken.  This should weaken them and allow us to bring this civil war to an end.  Before you go here is the reward for bringing the ingredients." ]]
			...
			evt.Subtract("QBits", 138)         -- "Return to Aelwen in Avalon  with a Personality Potion and an Intellect Potion."
			evt.Set("Awards", 45)         -- "Delievred ingredients for Ceridwin's Elixir"
			evt.Set("QBits", 139)         -- "Purify the Alter of Agrona."
			evt.ForPlayer("Current")
...
So what are you waiting for?  Get going!" ]]
		evt.Subtract("QBits", 141)         -- "Bring the Pearl of Turmoil to Mallt in Avalon."
		evt.Set("Awards", 48)         -- "Found the Pearl of Turmoil"
		evt.Set("QBits", 143)         -- "Exchange the Pearl of Turmoil for the Pearl of Fertility in the Druid Temple and return to Malt in Avalon."
		evt.Add("Gold", 5000)
...
Here’s you reward." ]]
		...
		evt.Subtract("QBits", 143)         -- "Exchange the Pearl of Turmoil for the Pearl of Fertility in the Druid Temple and return to Malt in Avalon."
		evt.Set("Awards", 49)         -- "Placed Pearl of Turmoil in Druid Chest"
		evt.Add("Gold", 8000)
...
[Trevor responds] I prefer that you send her to her goddess for punishment.  Do that and you will earn not only my praise but the praise of the council as well." ]]
	evt.Set("QBits", 144)         -- "Slay Morrigan’s Leader in Glastonbury Tor and return Fire Amulet to Trevor O'Farrell in Port Sleigon."
...
evt.global[302] = function()
	...
	if evt.Cmp("Inventory", 579) then         -- "Fire Amulet"
		...
		evt.Subtract("QBits", 144)         -- "Slay Morrigan’s Leader in Glastonbury Tor and return Fire Amulet to Trevor O'Farrell in Port Sleigon."
		evt.Set("Awards", 51)         -- "Killed the leader of Morrigan’s Followers"
		evt.Add("Experience", 12500)
		evt.Add("Gold", 2500)
		evt.Add("ReputationIs", 200)
...
My son discovered his wife was unfaithful, so he left the land seeking battle to forget his sorrows.  As he traveled he repaid his wife’s infidelity by seducing dozens of women.  This created many enemies who killed him.  They cremated him and divided the remains into six urns which they scattered throughout the realm.   Find the six urns and return them to me along with a potion of the god Ukko to heal him,.  The potion can only be made by an alchemist in Norseland.  Your reward will be great but beware my son’s wife, Kylliki would do anything to prevent you from succeeding in this venture." ]]
	evt.Add("QBits", 145)         -- "Find the six urns containing Lemkanen ashes and the Potion of the God Ukko and return to to Ilmatar in Tuonela."
...
You have made this mother very happy!  May the gods bless you.  Here's your reward." ]]
								...
								evt.Subtract("QBits", 145)         -- "Find the six urns containing Lemkanen ashes and the Potion of the God Ukko and return to to Ilmatar in Tuonela."
								evt.Set("Awards", 53)         -- "Reunited mother and son with the return of Lemkanen"
								evt.Add("Experience", 20000)
								evt.Add("ReputationIs", 200)
								evt.Add("Gold", 2500)
								evt.SetNPCTopic{NPC = 130, Index = 0, Event = 0}         -- "Ilmatar"
								evt.SetNPCTopic{NPC = 111, Index = 0, Event = 0}         -- "Kylliki"
								evt.Subtract("QBits", 162)         -- "Find the six urns containing Lemkanen ashes and the Potion of the God Ukko and return to Kylliki in Tuonela."
								return
							end
						end
					end
...
But beware! his mother, Ilmatar, would do anything to prevent me from being reunited with my husband." ]]
	evt.Add("QBits", 162)         -- "Find the six urns containing Lemkanen ashes and the Potion of the God Ukko and return to Kylliki in Tuonela."
...
Here, take your reward and leave me!  Let me savor my final revenge!" ]]
								...
								evt.Subtract("Inventory", 548)         -- "Urn #6"
								evt.Subtract("QBits", 162)         -- "Find the six urns containing Lemkanen ashes and the Potion of the God Ukko and return to Kylliki in Tuonela."
								evt.Set("Awards", 54)         -- "Reunited husband and wife with the return of Lemkanen"
								evt.Add("Experience", 20000)
								evt.Subtract("ReputationIs", 200)
								evt.Add("Gold", 2500)
								evt.SetNPCTopic{NPC = 111, Index = 0, Event = 0}         -- "Kylliki"
...
evt.global[308] = function()
	...
	evt.Add("QBits", 164)         -- "Solve the mystery of Danu’s Incantation and obtain the Treasure of Danu."
...
evt.global[309] = function()
	...
	evt.Set("QBits", 146)         -- "Return the Hourglass to Thomalina Thumb in Kat'an"
...
Please take this gold as your reward. I know it’s not much, but it’s all I can afford." ]]
		evt.Add("Awards", 56)         -- "Returned the Hourglass to Thomalina Thumb"
		evt.Add("Experience", 5000)
		evt.Add("Gold", 1250)
		evt.Subtract("Inventory", 433)         -- "Hourglass"
		evt.Subtract("QBits", 146)         -- "Return the Hourglass to Thomalina Thumb in Kat'an"
		evt.Add("ReputationIs", 50)
...
Oh! and here’s the Harbor Grace key.  You’ll  need it to gain entrance to the old place." ]]
	evt.Add("QBits", 166)         -- "Retrieve the Sacred Candelabra from Harbor Grace on Ellesia and return to Kinda Goode in Serenity."
...
Thank you. Here’s your reward." ]]
		evt.Subtract("QBits", 166)         -- "Retrieve the Sacred Candelabra from Harbor Grace on Ellesia and return to Kinda Goode in Serenity."
		evt.Add("Gold", 3000)
		evt.Add("ReputationIs", 50)
		evt.ForPlayer("All")
		evt.Add("Awards", 57)         -- "Retrieved the Sacred Candelabra"
		evt.Add("Experience", 20000)
...
evt.global[317] = function()
	evt.SetMessage(325)         -- "Hello.  Indis said to expect you.  I am Tanfana.  You must have noticed the continual snow fall in the Demonclaw.  It has gone on now for two years without relief.  It is said if the snow continues for three years, Fimbulvetr will end and Ragnorak will begin.  The Sun Goddess Sol has been prevented from casting her warmth on the region.  Her horse Dagr was poisoned and cannot pull the Trundholm Sun Chariot.  Only the Statue of Holy Cleansing can cure it.  Find and bring it here so this eternal winter can end and Ragnorak can be stopped.  Take this key and scroll, it will explain much that I have not.  Bring me the statue and I will see its curative power is invoked."
	evt.Add("QBits", 201)         -- "Enter Ched Rhinn, retrieve the Statue of Holy Cleansing, and return to Tanfana in Norseland."
...
After you have conducted any remaining business, you should return to the Seer." ]]
		...
		evt.Subtract("QBits", 201)         -- "Enter Ched Rhinn, retrieve the Statue of Holy Cleansing, and return to Tanfana in Norseland."
		evt.Add("Gold", 10000)
		evt.Subtract("Inventory", 502)         -- "Tanfan's Scroll"
		evt.ForPlayer("All")
		evt.Add("Awards", 59)         -- "Ended Winter in Demonclaw and stopped Ragnorak."
		evt.Add("Experience", 50000)
...
evt.global[323] = function()
	...
	if evt.Cmp("Inventory", 400) then         -- "Mordred"
		...
		evt.Add("Awards", 47)         -- "Purified Alter of Agrona"
...
evt.global[324] = function()
	...
	evt.Add("QBits", 138)         -- "Return to Aelwen in Avalon  with a Personality Potion and an Intellect Potion."
...
evt.global[325] = function()
	if evt.Cmp("NPCs", 193) then         -- "FREE"
		...
		evt.Add("Gold", 2000)
		evt.ForPlayer("All")
		evt.Add("Awards", 48)         -- "Found the Pearl of Turmoil"
		evt.Add("Experience", 10000)
...
evt.global[329] = function()
	if evt.Cmp("NPCs", 195) then         -- "Monsignor Hyppo Krit"
		...
		evt.Add("Food", 10)
		evt.ForPlayer("All")
		evt.Add("Awards", 49)         -- "Placed Pearl of Turmoil in Druid Chest"
...
Please go to Chernoburg and bring Maikki back to me." ]]
	evt.Add("QBits", 140)         -- "Bring Maikki Barthold back to Tierney Quinn in Port Sleigon."
...
What?  Oh yes of course.  Here, take it and leave.  Can’t you see we want to be alone." ]]
		...
		evt.Subtract("QBits", 140)         -- "Bring Maikki Barthold back to Tierney Quinn in Port Sleigon."
		evt.SetNPCTopic{NPC = 155, Index = 0, Event = 0}         -- "Thomalina Thumb"
		evt.Add("Gold", 1500)
		evt.ForPlayer("All")
		evt.Add("Experience", 10000)
		evt.Add("Awards", 50)         -- "Reunited Tierney Quinn with his fiancée."
...
I urge you to see Tanfana before you enter Ched Rhinn.  She can be found in Norseland and has another task in that same city." ]]
	evt.Set("QBits", 200)         -- "Activate the Pedestal in Norseland, enter Ched Rhinn, slay the Demon Breeder, and return to Indis in Castle Birka."
	evt.Subtract("QBits", 165)         -- "Visit Indis Nénharma in Castke Birka."
...
[Indis takes a deep breath ans speaks in a low tone] Never under estimate the Drow.  I’m sure other priestesses are pregnant with the Draegloth.  They are too devious to allow any single group from destroying all of them.  It is true you succeeded here and set their timeline back, but it may also be true they have succeeded elsewhere.  Thank you for your service and take your reward along with my thanks.  I must leave and return to my elfin brethren." ]]
		evt.Subtract("Inventory", 455)         -- "Demon Claw"
		evt.Subtract("QBits", 200)         -- "Activate the Pedestal in Norseland, enter Ched Rhinn, slay the Demon Breeder, and return to Indis in Castle Birka."
		evt.Add("Awards", 58)         -- "Stopped the creation of Draegloths in Ched Rhinn."
		evt.SetNPCTopic{NPC = 9, Index = 1, Event = 33}         -- "The Seer" : "It's time to deal with Chaos."
...
evt.global[335] = function()
	if evt.Cmp("QBits", 17) then         -- 17 D17, given when wolf altar is destroyed.
		...
		evt.ForPlayer("All")
		evt.Add("Experience", 20000)
		evt.Add("Awards", 52)         -- "Killed the Berserker Leader"
...
[Bogna continues.]  I am not sure he is worthy, he ruined the reputation of many women.  His death could be considered justice.  However, mine is not to reason the good or bad of the man but to render aid to those who seek it.  Against my better judgement I will create one for you.  Bring me a Potion of Divine Cure and a Potion of Rejuvenation and you will have your potion." ]]
	evt.Set("QBits", 235)         -- "Bring Potions of Divine Cure and Rejuvenation to Bogna in Norseland, for the Potion of Ukko."
...
Well mixing black potions takes not only skill but patience.  Here is your potion.  Bring him back if you wish, but your actions will be judged by whatever god you follow." ]]
			evt.Subtract("QBits", 235)         -- "Bring Potions of Divine Cure and Rejuvenation to Bogna in Norseland, for the Potion of Ukko."
...
evt.global[341] = function()
	...
	if evt.Cmp("Inventory", 458) then         -- "Pearl of Turmoil"
		...
		evt.Add("Experience", 5000)
		evt.Add("Awards", 51)         -- "Killed the leader of Morrigan’s Followers"
		evt.ForPlayer("Current")
		evt.Subtract("QBits", 143)         -- "Exchange the Pearl of Turmoil for the Pearl of Fertility in the Druid Temple and return to Malt in Avalon."
...
[Dismissing your answer, Jaana continues.]  It is said that Rusalki like to seduce men.  They can do so by enticing men with their singing and then drowning them.  I don’t believe it, I mean why drown them?  I believe they have captured them and are keeping them for their own uses in the Temple on the island to the east of here.  You go free the men and return and I’ll reward you for your efforts." ]]
	evt.Add("QBits", 219)         -- "Save the young men of Chernobog from the Rusalki"
...
[This time you made it to the door.] That’s quite alright.  Thank you for the reward, but we really must be going." ]]
		...
		evt.ForPlayer("All")
		evt.Subtract("QBits", 219)         -- "Save the young men of Chernobog from the Rusalki"
		evt.Add("Awards", 36)         -- "Rescued the young men of Chernobog"
		evt.Add("Experience", 10000)
	else
...
evt.global[353] = function()
	if evt.Cmp("QBits", 140) then         -- "Bring Maikki Barthold back to Tierney Quinn in Port Sleigon."
		if evt.Cmp("QBits", 203) then         -- NPC
			evt.SetMessage(105)         -- "This is glorious news; Jaana is happily distracted by all of the attention the men are paying her.  I can now accompany you to Port Sleigon.  We best hurry in case none of the men are serious."
...
evt.global[355] = function()
	...
	evt.Add("QBits", 144)         -- "Slay Morrigan’s Leader in Glastonbury Tor and return Fire Amulet to Trevor O'Farrell in Port Sleigon."
...
You are about to enter The VOID, my friends.  It is through The VOID that you will go back in-time to enter Creation's Land shortly after the Chalice of the Gods became corrupt.  You must find this chalice and destroy it.  This is the only way to restore the Fabric of Time and 'set things right' in present Nimradur.
...
evt.global[358] = function()
	evt.SetMessage(433)         --[[ "I must be honest, adventurers.  This is a one-way journey.  Once you enter The VOID, you can not return to Nimradur.  However, if you are successful, your deeds will become legend in Nimradur and your names will be immortalized.
...
[As you are leaving, the Rose's fragrance wafts throughout the house. You notice that Klaravoyia's flock of birds has begun to perk up and sing melodiously.]" ]]
	...
	evt.Add("ReputationIs", 100)
	evt.ForPlayer("All")
	evt.Subtract("QBits", 118)         -- "Return with the Last Rose of Winter to Baronness Klaravoiya in Avalon."
...
evt.global[366] = function()
	...
	evt.Add("ReputationIs", 100)
	evt.ForPlayer("All")
	evt.Subtract("QBits", 119)         -- "Drink from Creations Fount and return to Klaravoiya."
...
Let’s get start." ]]
	...
	evt.Subtract("QBits", 201)         -- "Enter Ched Rhinn, retrieve the Statue of Holy Cleansing, and return to Tanfana in Norseland."
	if evt.Cmp("QBits", 200) then         -- "Activate the Pedestal in Norseland, enter Ched Rhinn, slay the Demon Breeder, and return to Indis in Castle Birka."
		evt.Subtract("QBits", 200)         -- "Activate the Pedestal in Norseland, enter Ched Rhinn, slay the Demon Breeder, and return to Indis in Castle Birka."
	end
