...
evt.MazeInfo = evt.str[7]  -- "Disordered Sanctum"
...
evt.map[34] = function()
	evt.DamagePlayer{Player = 0, DamageType = const.Damage.Magic, Damage = 500}
	evt.DamagePlayer{Player = 1, DamageType = const.Damage.Magic, Damage = 500}
	evt.DamagePlayer{Player = 2, DamageType = const.Damage.Magic, Damage = 500}
	evt.DamagePlayer{Player = 3, DamageType = const.Damage.Magic, Damage = 500}
end

evt.hint[35] = evt.str[5]  -- "Exit"
evt.map[35] = function()
	evt.MoveToMap{X = 17078, Y = -6601, Z = 161, Direction = 1280, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "OutB1.Odm"}
end
